...
async getPaginatedRows(tableName: string, pageIndex: number, pageSize: number) : Promise<PaginatedRows> {
    return await TAURI_INVOKE("get_paginated_rows", { tableName, pageIndex, pageSize });
},
 ...
 */
export type CustomColumnType = "string" | "text" | "uuid" | "float" | "positiveInteger" | "boolean" | "integer" | "date" | "dateTime" | "time" | "year" | "json" | "binary" | "custom" | "unSupported"
/**
