...
const Updater = () => {
  return (
    <div className="dark:bg-dot-white/[0.6] bg-dot-black/[0.6] relative flex h-[130px] w-full items-center justify-center gap-2 bg-white md:gap-y-8 lg:h-full dark:bg-black">
