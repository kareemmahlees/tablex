...
export type ColumnForFor = { columnName: string; columnType: CustomColumnType }
...
export type GetRowsPayload = { tableName: string; columns: ColumnForFor[]; pagination: PaginationData; sorting: SortingData[]; filtering: FilteringData[] }
